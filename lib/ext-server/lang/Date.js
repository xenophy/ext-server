...
//#JSCOVERAGE_ENDIF
     ...
     *
     * @param {String} input {Ext_Date:method-parse:param_input}
     * @param {String} format {Ext_Date:method-parse:param_format}
     * @param {Boolean} strict {Ext_Date:method-parse:param_strict}
