...
Ext.Loader = new function() {
    ...
    Ext.apply(Loader, {
        ...
        updateLatest: function(name) {
            ...
            if(Ext.isString(classNameToFilePathMap[name])) {

                if(classFileModified[name] < require('fs').statSync(classNameToFilePathMap[name]).mtime) {
                    delete require.cache[classNameToFilePathMap[name]];
                    require(classNameToFilePathMap[name]);
                    return false;
                }
