...
Ext.define('Ext.server.UserAgent', {
    ...
    apply: function(target) {
        ...
        /**
         * {Ext_server_action_Action:method-is:desc}
         * @member Ext.server.action.Action
         * @method is
         * @param {String} id {Ext_server_action_Action:method-is:param_id}
         * @return {Boolean} {Ext_server_action_Action:method-is:return}
         */
