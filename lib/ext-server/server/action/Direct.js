                ...
                fin = function(tid, o) {
                    ...
                    if(finall) {
                        ...
                        if(single) {
                            ...
                            Ext.iterate(finmods, function(k, v) {
                                ret.push(Ext.JSON.decode(v.render.data));
                            });

                            var output = Ext.JSON.encode(ret);
                ...
                Ext.iterate(post, function(k, post) {
                    ...
                    arg.push(function(result) {
                        ...
                        if(isUpload) {
                            ...
                            var output = Ext.sprintf('<html><body><textarea>%s</textarea></body></html>', ret);
