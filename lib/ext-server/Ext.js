...
(function() {
    ...
    Ext.$dependencies = {
        ...
        //connect: require('/Users/kotsutsumi/UserDir/connect/lib/connect')
        // }}}
    ...
    require('./server/middleware/BodyParser');
    require('./server/middleware/Compress');
    require('./server/middleware/CookieParser');
    require('./server/middleware/Session');
    require('./server/middleware/Static');
